...
#include "../GUIElicottero/controlwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ControlWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 42, 4)
    ...
    "ControlWindow\0controlHeli\0\0QPoint&\0"
    "newPos\0stop\0"
};
...
void ControlWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->controlHeli((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        ...
        {
            typedef void (ControlWindow::*_t)(QPoint & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ControlWindow::controlHeli)) {
                *result = 0;
            }
        }
        {
            typedef void (ControlWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ControlWindow::stop)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ControlWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ControlWindow.data,
      qt_meta_data_ControlWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ControlWindow.stringdata))
...
// SIGNAL 0
void ControlWindow::controlHeli(QPoint & _t1)
{
